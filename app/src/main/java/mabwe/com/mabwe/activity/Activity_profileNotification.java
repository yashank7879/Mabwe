...
public class Activity_profileNotification extends AppCompatActivity {
        ...
        if (getIntent().getStringExtra("userid") != null) {
            ...
            Log.i("screenFlag23542", "screenFlag: " + screenFlag);
                ...
                if (bundle.getString("notify_id") != null) {
                    userid = bundle.getString("notify_id");
                }
            }
   ...
   /*     if (screenFlag.equals("fromConnection")) {
         ...
         session = new Session(Activity_profileNotification.this);
    ...
    public void onBackPressed() {
        ...
        intent.putExtra("type","Mabweconnect");
