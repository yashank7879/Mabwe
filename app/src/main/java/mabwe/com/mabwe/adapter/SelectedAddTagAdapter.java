...
public class SelectedAddTagAdapter   extends RecyclerView.Adapter<SelectedAddTagAdapter.ViewHolder> {

    private ArrayList<TagModal> arrayList;
    private Context context;
    private RemoveListItemListener removeListItemListener;

    public SelectedAddTagAdapter(ArrayList<TagModal> arrayList, Context context, RemoveListItemListener removeListItemListener) {
    ...
    @NonNull
    @Override
    public SelectedAddTagAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tag_view, parent, false);
        return new SelectedAddTagAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SelectedAddTagAdapter.ViewHolder holder, final int position) {
